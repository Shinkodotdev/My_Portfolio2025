...
Assisted in document management including scanning, printing, and distributing project plans.`,
    ...
    responsibilities: [
      ...
      "Provided document tracking and printing efficiently using this system",
    ],
  },
];
...
// Social Media Links
const socialImgs = [
  { name: "Instagram", imgPath: "/images/logos/instagram.png", link: "https://www.instagram.com/shinkodotdev/" },
...
const certificates = [
  {
    ...
    date: 'June 2024',
    description: 'Comprehensive bootcamp covering Linux and SQL fundamentals.',
  ...
  },
  {
    ...
    date: 'July 2024',
    description: 'Introductory course on cybersecurity principles and practices.',
  ...
  },
  {
    ...
    date: 'August 2024',
    description: 'Focused on managing security risks in IT environments.',
  ...
  },
  {
    ...
    date: 'September 2024',
    description: 'Course on network fundamentals and security measures.',
  ...
  },
  {
    ...
    date: 'October 2024',
    description: 'Introductory course on database concepts and SQL.',
  ...
  },
  {
    ...
    date: 'November 2024',
    description: 'Beginner-friendly course on front-end web development using HTML, CSS, and JavaScript.',
...
const skill = [
  ...
  { name: 'Node.js', icon: '/images/logos/node.png', level: 1 },
